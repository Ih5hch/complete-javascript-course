...
const startLogOutTimer = () => {
  const tick = () => {
    ...
    // In each calling print the remaining time to UI
...
console.log(Number.parseInt('e23', 10)); //should starts with number
...
console.log(Number.isInteger('20'));
console.log(Number.isInteger(+'23px'));
...
console.log(Math.max(2, 45, 67, 87));
console.log(Math.max(2, '45', 67, 87));

console.log(Math.min(2, 45, 67, 87));
console.log(Math.min(2, '45', 67, 87));
...
const now = new Date();
console.log(now);
console.log(new Date('October 13,2013'));

console.log(new Date(2013, 11, 9, 15, 53, 45));
...
const pizzaTimer = setTimeout(
  (ing1, ing2) => console.log(`Pizza is delivered with ${ing1} and ${ing2}`),
  3000,
  ...ingredients
);
